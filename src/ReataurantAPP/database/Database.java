...
//    private final static String WAGE_INFO_FILE = "dataFiles/wage_info.txt";
    ...
    private ArrayList<OrderOld> orderList = new ArrayList<OrderOld>();
    
    private Date    date;
    int     todaysOrderCounts;
    private User user;
    private Item item;
//    private OrderOld orderN;
    private Transaction transaction;
    private List<Item> items = new ArrayList<Item>();
    private List<OrderOld> orderOlds = new ArrayList<OrderOld>();
    ...
    public ArrayList<OrderOld> getOrderList()
    {
        return orderList;
    }
   ...
   // Find order from ID
   //----------------------------------------------------------
   public OrderOld   findOrderByID(int id)
   {
       Iterator<OrderOld> it = orderList.iterator();
       OrderOld           re = null;
       boolean         found = false;
...
//    }
    ...
    public int addOrder(int staffID, String staffName)
    {
        ...
        OrderOld newOrder = new OrderOld(staffID, staffName);
    ...
    {
        OrderOld rOrder = findOrderByID(orderID);
    ...
    public boolean cancelOrder(int orderID)
    {
       ...
       if(rOrder == null)
           return false;
        rOrder.setState(OrderOld.ORDER_CANCELED);
        return true;
    }
    ...
    public boolean closeOrder(int orderID)
    {
       ...
       if(rOrder == null)
           return false;
        rOrder.setState(OrderOld.ORDER_CLOSED);
        return true;
    }
    ...
    public void closeAllOrder()
    {
       ...
       while (it.hasNext()) {
           ...
           {
               re.setState(OrderOld.ORDER_CLOSED);
           }
       }
    }
    ...
    {
        OrderOld  re = findOrderByID(orderID);
        if(re == null)
            return -1;
        return re.getState();
    }
...
////        	   System.out.println("552 " + s.getID() + "  " + s.getPassword() +" " + s.getFullName());
////           }
//          
//           reader.close();
//       } catch (IOException ioe) {
...
//               switch(state)
//               {
//                   case OrderOld.ORDER_CLOSED:
//                       stateString = "";
//                       totalAllOrder += totalOfEachOrder;
//                       orderCnt++;
//                   break;
//                   case OrderOld.ORDER_CANCELED:
...
//                   break;
//               }
//               String output = String.format("OrderOld ID:%4d  StaffName:%-30s  Total:$%-5.2f %s\r\n",
...
//                   String output = String.format("OrderOld ID:%4d  StaffName:%-30s  Work time:%-5.2f Pay:%-5.2f\r\n",
...
//   
   ...
   ***************************************************************************/
   ...
   private class MenuItemComparator implements Comparator<MenuItem> {
	...
	/**
	 * @param orderOlds the orderOlds to set
	 */
	public void setOrders(List<OrderOld> orderOlds) {
		this.orderOlds = orderOlds;
	}
